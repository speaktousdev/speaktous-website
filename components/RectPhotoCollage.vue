<template>
  <div class="parent">
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div3">
      <img
    ...
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div2">
      <img
    ...
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div4">
      <img
    ...
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div8">
      <img
    ...
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div1">
      <img
    ...
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div9">
      <img
    ...
    <div
      ...
      class="chi bg-placeholder div10"
    >
      <img
    ...
    <div
      v-lazy-container="{ selector: 'img' }"
      class="chi bg-placeholder div13"
    >
      <img
    ...
    <div
      v-lazy-container="{ selector: 'img' }"
      class="chi bg-placeholder div15"
    >
      <img
    ...
    <div
      v-lazy-container="{ selector: 'img' }"
      class="chi bg-placeholder div16"
    >
      <img
    ...
    <div
      v-lazy-container="{ selector: 'img' }"
      class="chi bg-placeholder div17"
    >
      <img
    ...
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div6">
      <img
    ...
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div7">
      <img
    ...
    <div
      v-lazy-container="{ selector: 'img' }"
      class="chi bg-placeholder div18"
    >
      <img
    ...
    <div
      v-lazy-container="{ selector: 'img' }"
      class="chi bg-placeholder div12"
    >
      <img
    ...
    <div
      v-lazy-container="{ selector: 'img' }"
      class="chi bg-placeholder div14"
    >
      <img
    ...
    <div v-lazy-container="{ selector: 'img' }" class="chi bg-placeholder div5">
      <img
    ...
    <div
      v-lazy-container="{ selector: 'img' }"
      class="chi bg-placeholder div11"
    >
      <img
...
.children {
  @apply w-20 h-32 transition duration-100 ease-in-out transform bg-gray-300;
}

.children:hover {
  @apply scale-150 z-30 relative;
}
